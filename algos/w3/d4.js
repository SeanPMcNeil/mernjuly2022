...
const hoodie = new Product("B075JV7RWV", "Amazon Essentials Zip Sweatshirt", 20.4, "https://www.amazon.com/dp/B075JV7RWV?ref=ppx_yo2ov_dt_b_product_details&th=1&psc=1%22");
const algaeOmega = new Product("B081QQ7PRP", "Nordic Naturals Algae Omega", 36.99, "https://www.amazon.com/gp/product/B081QQ7PRP/ref=ppx_yo_dt_b_asin_title_o09_s00?ie=UTF8&psc=1%22");
const broccoMax = new Product("B01D15LMCK", "Jarrow Formulas BroccoMax", 29.63, "https://www.amazon.com/gp/product/B01D15LMCK/ref=ppx_yo_dt_b_asin_title_o00_s00?ie=UTF8&psc=1%22");
const tearsOfChios = new Product("B07Q454QLH", "Chios Mastiha Gum", 16.9, "https://www.amazon.com/gp/product/B07Q454QLH/ref=ppx_yo_dt_b_asin_title_o00_s01?ie=UTF8&psc=1%22");
const wideYogaMat = new Product("B086BZL6JT", "CAMBIVO Extra Wide Yoga Mat", 39.99, "https://www.amazon.com/gp/product/B086BZL6JT/ref=ppx_yo_dt_b_asin_title_o06_s01?ie=UTF8&psc=1%22");
const travelBackpack = new Product("B07RM5D4XV", "Hynes Eagle 45L Travel Backpack", 64.99, "https://www.amazon.com/gp/product/B07RM5D4XV/ref=ppx_yo_dt_b_asin_title_o01_s01?ie=UTF8&psc=1%22");
...
function addAllToCart(cart, wishlist) {
    let finalCart = [];
...
console.log(addAllToCart(shoppingCart1, wishList1));
...
console.log(addAllToCart(shoppingCart2, wishList2));
...
console.log(addAllToCart(shoppingCart3, wishList3));

const shoppingCart4 = [hoodie];
const wishList4 = [];
const expected4 = [hoodie];
console.log(addAllToCart(shoppingCart4, wishList4));